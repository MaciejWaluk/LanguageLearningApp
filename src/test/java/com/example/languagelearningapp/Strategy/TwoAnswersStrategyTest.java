...
class TwoAnswersStrategyTest {

    static LanguageState languageState;
    TwoAnswersStrategy twoAnswersStrategy;
    List<Word> result;
    Word word;
    ...
    void setUp() {
        ...
        twoAnswersStrategy = new TwoAnswersStrategy();
        result = twoAnswersStrategy.createAnswers(word, languageState);
    }
